...
return array(
	...
	//获取所有分类下的商品列表
	'getCategoryAllList'=>array(
	    'query'=>array(
	    	'name'  => 'category_extend as ca',
	    	'join'  => 'left join goods as go on go.id = ca.goods_id',
	    	'where' => ' ca.category_id != 0 and go.is_del = 0',
	    	'order' => ' go.sort asc,go.id desc',
	    	'limit' => 10,
	    )
	),
	...
	//根据项目分类取得项目列表
	'getProjectListByCategory'=>array(
	    'query'=>array(
	    	'name'  => 'project_category as ca',
	    	'join'  => 'left join project as pr on pr.category_id = ca.id',
	    	'where' => ' ca.id = #categroy_id#',
	    	'order' => ' pr.sort asc,pr.id desc',
	    	'limit' => 10,
	    )
	),
	//根据项目分类取得项目列表
	'getProjectListAll'=>array(
	    'query'=>array(
	    	'name'  => 'project_category as ca',
	    	'join'  => 'left join project as pr on pr.category_id = ca.id',
	    	'where' => ' pr.category_id != 0 and top = #top#',
	    	'order' => ' pr.sort asc,pr.id desc',
	    	'limit' => 10,
	    )
	),
	...
	//根据人才分类取得项目列表
	'getRencaiListByCategory'=>array(
	    'query'=>array(
	    	'name'  => 'rencai_category as ca',
	    	'join'  => 'left join rencai as pr on pr.category_id = ca.id',
	    	'where' => ' ca.id = #categroy_id#',
	    	'order' => ' pr.sort asc,pr.id desc',
	    	'limit' => 10,
	    )
	...
	//根据人才分类取得项目列表
	'getFundListByCategory'=>array(
	    'query'=>array(
	    	'name'  => 'fund_category as ca',
	    	'join'  => 'left join fund as pr on pr.category_id = ca.id',
	    	'where' => ' ca.id = #categroy_id#',
	    	'order' => ' pr.sort asc,pr.id desc',
	    	'limit' => 10,
	    )
	...
	//根据文章分类取得项目列表
	'getArticleListByCategory'=>array(
	    'query'=>array(
	    	'name'  => 'article_category as ca',
	    	'join'  => 'left join article as pr on pr.category_id = ca.id',
	    	'where' => ' ca.id = #categroy_id#',
	    	'order' => ' pr.sort asc,pr.id desc',
	    	'limit' => 10,
	    )
