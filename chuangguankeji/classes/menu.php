...
class Menu
{
	...
	private static $menu = array(
		'专利'=>array(
			'专利管理'=>array(
				'/goods/goods_list' => '专利列表',
				'/goods/goods_edit' => '专利添加'
			),
			'专利分类'=>array(
  ...
  //     			'/market/amount'       => '销售金额统计'
       ...
       '众筹'=>array(
			...
			'项目分类'=>array(
				'/fund/fund_cat_list'=> '分类列表',
				'/fund/fund_cat_edit'=> '分类添加'
			),

			'支持纪录管理'=>array(
   				'/orderfund/order_list'=> '纪录列表',
				'/orderfund/order_recycle_list'=> '回收站',
				'/orderfund/order_show'=> '查看记录'
   			)
		),

       '人才'=>array(
			'人才管理'=>array(
				'/rencai/rencai_list' => '人才列表',
				'/rencai/rencai_edit' => '人才添加',
			),
			'人才分类'=>array(
				'/rencai/rencai_cat_list'=> '分类列表',
				'/rencai/rencai_cat_edit'=> '分类添加'
			),
       ...
       '项目'=>array(
			'项目管理'=>array(
				'/project/project_list' => '项目列表',
				'/project/project_edit' => '项目添加',
			),
			'项目分类'=>array(
				'/project/project_cat_list'=> '分类列表',
				'/project/project_cat_edit'=> '分类添加'
			),
			'咨询管理'=>array(
				'/project/project_feedback_list'=> '咨询列表'
			),
