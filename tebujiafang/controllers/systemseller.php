	...
	public function login()
	{
        ...
        else
		{
			...
			if($sellerRow && ($sellerRow['password'] == md5($password)))
			{
				...
				ISafe::set('seller_type_id',$sellerRow['type_id']);

				//wj 2016-03-29 11:49:24 代理商 直销商 判断
				if($sellerRow['type_id']==1){
					$this->redirect('/seller_direct/index');
				}elseif($sellerRow['type_id']==2){
