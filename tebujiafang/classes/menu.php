...
class Menu
{
	...
	private static $menu = array(
		'商品'=>array(
			'商品管理'=>array(
				'?controller=goods&action=goods_list&search[seller_id]==0&search[is_del]=&search[store_nums]=&search[commend_id]=&search[name]=go.name&search[keywords]=' => '平台商品列表',
				'?controller=goods&action=goods_list&search[seller_id]=!=0&search[is_del]=&search[store_nums]=&search[commend_id]=&search[name]=seller.true_name&search[keywords]=' => '代理商商品列表',
		...
		'会员'=>array(
			...
			'直销用户管理' => array(
				'/member/seller_list' => '直销用户列表',
				'/member/seller_edit' => '添加直销用户',
			),
			'代理商管理' => array(
				'/member/seller2_list' => '代理商列表',
				'/member/seller2_edit' => '添加代理商',
			),
			'信息处理' => array(
  ...
  //       	),
  //       	// '分销设置'=>array(
  //       	// 	'/agent/group_list'       => '代理商组列表',
  //       	// 	'/agent/set_rebate'       => '分销佣金设置',
  //       	// )
		// ),
		...
		'统计'=>array(
			...
			'商户提成明细'=>array(
				'/market/order_commission_list' => '直销商明细列表',
				'/market/order_commission_list2' => '代理商明细列表',
			)
		),
